                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-8 w-fit mx-auto">
                        {characters.map((character: Character) => {
                            return (
                                <div title={`Go to detail page of ${character.name}`} onClick={() => navigate(`/character/${character.id}`)} key={character.id} className="col-span-1 w-90 rounded-lg shadow-lg p-4 border bg-white border-gray-200">
