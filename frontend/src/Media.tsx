...
const Medias = () => {
    ...
    useEffect(() => {
        const loadData = async () => {
            try {
                const data = await apiService.getMedia(page);
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-8">
            ...
            {loading ? (
                <p className="text-2xl">loading medias...</p>
            ) : (
                <div>
                    <h2 className="text-2xl text-center font-medium text-disney-blue mb-4">All Media</h2>
                    <MediaOverview medias={medias} />
